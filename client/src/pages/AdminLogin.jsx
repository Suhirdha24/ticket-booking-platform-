        ...
        >
          <div>
            ...
            <p style={{ color: '#94A3B8', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '2.5rem' }}>
              Manage 4,750+ live events across 60+ Indian cities, oversee 160-seat atomic reservations, monitor real-time ticket revenue, and validate QR gate passes.
            </p>
          ...
          >
            ...
            <div style={{ fontSize: '0.75rem', fontWeight: 800, color: '#A78BFA', background: 'rgba(139, 92, 246, 0.15)', padding: '0.2rem 0.5rem', borderRadius: '4px' }}>
              v2.5 Security
            </div>
          </div>
        </div>
